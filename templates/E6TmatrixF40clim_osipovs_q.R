E6TmatrixF40clim.R GISS ModelE Lat-Lon Atmosphere Model, 65m q-flux slab ocn/atm MATRIX tracers

E6TmatrixF40clim: E6TmatrixF40 but swap emissions to climatological
               (e.g. 9-year averages centered around nominal date)
		osipovs: q-flux changes were obtained from P4M40.R and P4qM40.R diff
...
E6TmatrixF40clim_osipovs_q (q-flux slab ocean atmospheric tracer model with MATRIX and Shindell chemistry)
