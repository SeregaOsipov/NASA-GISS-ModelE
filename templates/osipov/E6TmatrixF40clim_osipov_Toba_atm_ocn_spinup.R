...
Data input files:
#include "IC_144x90_input_files_osipov_Toba_spinup"
...
&INPUTZ
 YEARI=1954,MONTHI=1,DATEI=1,HOURI=0, ! pick IYEAR1=YEARI (default) or < YEARI
 YEARE=1960,MONTHE=1,DATEE=1,HOURE=0,     KDIAG=12*0,9,
 ISTART=9,IRANDI=0, YEARE=1954,MONTHE=1,DATEE=1,HOURE=1,
/
