...
#include "latlon_source_files_osipov_Toba"
...
Data input files:
#include "IC_144x90_input_files_osipov_Toba_ss"
#include "dynamic_ocn_288x180_input_files_AR5_osipov_Toba"
...
#include "chemistry_input_files_nosoa_osipov_Toba"
...
#include "diag_params_osipov_Toba"
...
&INPUTZ
 YEARI=1951,MONTHI=1,DATEI=1,HOURI=0, ! pick IYEAR1=YEARI (default) or < YEARI
 YEARE=1955,MONTHE=1,DATEE=1,HOURE=0,     KDIAG=12*0,9,
 ISTART=9,IRANDI=0, YEARE=1951,MONTHE=1,DATEE=1,HOURE=1,
/
